...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/behavior_tree"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/behavior_tree/environment/library_path.sh"
