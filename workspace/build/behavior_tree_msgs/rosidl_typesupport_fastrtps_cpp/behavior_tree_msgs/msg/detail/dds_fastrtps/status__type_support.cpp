...
#include "behavior_tree_msgs/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const behavior_tree_msgs::msg::Status & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  behavior_tree_msgs::msg::Status & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_tree_msgs::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const behavior_tree_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<behavior_tree_msgs::msg::Status *>(
    untyped_ros_message);
...
{
  return &behavior_tree_msgs::msg::typesupport_fastrtps_cpp::_Status__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, behavior_tree_msgs, msg, Status)() {
  return &behavior_tree_msgs::msg::typesupport_fastrtps_cpp::_Status__handle;
}
