...
class Metaclass_Status(type):
    ...
    def FAILURE(self):
        ...
        return Metaclass_Status.__constants['FAILURE']

    @property
    def RUNNING(self):
        """Message constant 'RUNNING'."""
        return Metaclass_Status.__constants['RUNNING']

    @property
    def SUCCESS(self):
        """Message constant 'SUCCESS'."""
        return Metaclass_Status.__constants['SUCCESS']
