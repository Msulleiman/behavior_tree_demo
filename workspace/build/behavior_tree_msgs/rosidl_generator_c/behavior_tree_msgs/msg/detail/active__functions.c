...
behavior_tree_msgs__msg__Active__create()
{
  ...
  behavior_tree_msgs__msg__Active * msg = (behavior_tree_msgs__msg__Active *)allocator.allocate(sizeof(behavior_tree_msgs__msg__Active), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_tree_msgs__msg__Active));
  bool success = behavior_tree_msgs__msg__Active__init(msg);
  if (!success) {
...
behavior_tree_msgs__msg__Active__destroy(behavior_tree_msgs__msg__Active * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    behavior_tree_msgs__msg__Active__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
behavior_tree_msgs__msg__Active__Sequence__init(behavior_tree_msgs__msg__Active__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__msg__Active * data = NULL;

  if (size) {
    data = (behavior_tree_msgs__msg__Active *)allocator.zero_allocate(size, sizeof(behavior_tree_msgs__msg__Active), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_tree_msgs__msg__Active__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        behavior_tree_msgs__msg__Active__fini(&data[i - 1]);
      }
...
behavior_tree_msgs__msg__Active__Sequence__fini(behavior_tree_msgs__msg__Active__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_tree_msgs__msg__Active__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_tree_msgs__msg__Active__Sequence * array = (behavior_tree_msgs__msg__Active__Sequence *)allocator.allocate(sizeof(behavior_tree_msgs__msg__Active__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_tree_msgs__msg__Active__Sequence__init(array, size);
  if (!success) {
...
behavior_tree_msgs__msg__Active__Sequence__destroy(behavior_tree_msgs__msg__Active__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_tree_msgs__msg__Active__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_tree_msgs__msg__Active__Sequence__are_equal(const behavior_tree_msgs__msg__Active__Sequence * lhs, const behavior_tree_msgs__msg__Active__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_tree_msgs__msg__Active__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_tree_msgs__msg__Active__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_tree_msgs__msg__Active);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_tree_msgs__msg__Active * data =
      (behavior_tree_msgs__msg__Active *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_tree_msgs__msg__Active__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_tree_msgs__msg__Active__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_tree_msgs__msg__Active__copy(
