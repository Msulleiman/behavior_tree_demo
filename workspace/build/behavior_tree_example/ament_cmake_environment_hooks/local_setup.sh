...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/behavior_tree_example"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/behavior_tree_example/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/behavior_tree_example/environment/path.sh"
